...
function App() {
  ...
  useEffect(() => {
    ...
    const handleTabChange = () => {
      ...
      setStatusType('idle');
      // 延迟一点再提取，等待页面加载
      setTimeout(handleExtractAuto, 500);
    };
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      const response = await chrome.runtime.sendMessage({
        ...
        payload: { mode, pageContent, projectInfo },
      });
      ...
      <div className="main-content">
            ...
            {pageContent ? (
              <div className="extracted-content">
                ...
                <div className="extracted-item">
                  ...
                  <span className="extracted-value">{pageContent.bodyText.slice(0, 300)}...</span>
                </div>
                <div className="char-count">{pageContent.bodyText.length}/2000</div>
              </div>
            ) : (
              <div className="empty-hint">点击"提取"按钮获取页面内容</div>
            )}
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-header">
            ...
            {originalComment && <span className="card-badge">{originalComment.length} 字</span>}
          </div>
          <div className="card-body">
            {editingOriginal ? (
              <textarea
        ...
        <div className="card">
          <div className="card-header">
            ...
            {chineseComment && <span className="card-badge">{chineseComment.length} 字</span>}
          </div>
          <div className="card-body">
            {editingChinese ? (
              <textarea
